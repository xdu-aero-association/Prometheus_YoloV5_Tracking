...
pub_topic_name = rospy.get_param('~output_topic', '"/prometheus/object_detection/yolov5_tensorrt_det"')
...
pub = rospy.Publisher("/prometheus/object_detection/yolov5_tensorrt_det", MultiDetectionInfo, queue_size=1)
rate = rospy.Rate(100)
